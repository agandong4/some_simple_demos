...
data_ori = pd.read_csv('./EM_data/heros.csv',encoding='gb18030')
features = [u'最大生命',u'生命成长',u'初始生命',u'最大法力', u'法力成长',
            u'初始法力',u'最高物攻',u'物攻成长',u'初始物攻',u'最大物防',
            u'物防成长',u'初始物防', u'最大每5秒回血', u'每5秒回血成长',
            u'初始每5秒回血', u'最大每5秒回蓝', u'每5秒回蓝成长',
            u'初始每5秒回蓝', u'最大攻速', u'攻击范围']
data = data_ori[features]
# 对英雄属性之间的关系进行可视化分析
# #设置PLT正确显示中文
import matplotlib.font_manager as fm
# SimHerfont = fm.FontProperties('/Users/agan/Library/Fonts/SimHei.ttf')
# plt.rcParams['font.family'] = ['sans-serif'] #用于正确显示中文
...
#采用Z-Score 规范化数据，保证每个特征维度对数据均值为0，方差为1
ss = StandardScaler()
...
data_ori.to_csv('./EM_data/hero_out.csv',index=False,sep=',',encoding='gb18030')
